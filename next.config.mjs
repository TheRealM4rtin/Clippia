        ...
        headers: [
          {
            ...
            value: process.env.NODE_ENV === 'development'
              ...
              : "default-src 'self'; script-src 'self' 'unsafe-inline' https://*.stripe.com; style-src 'self' 'unsafe-inline'; connect-src 'self' https://*.stripe.com https://api.stripe.com https://r.stripe.com; frame-src https://*.stripe.com; img-src 'self' https://*.stripe.com data:;"
          },
