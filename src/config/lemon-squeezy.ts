...
export const LEMON_SQUEEZY_CONFIG = {
    ...
    products: {
        ...
        early_adopter: {
            variantId: process.env.LEMON_SQUEEZY_EARLY_ADOPTER_VARIANT_ID,
            name: 'Early Adopter',
            features: ['All Basic Features', 'Early Access to New Features', 'Priority Support']
        },
        support: {
            variantId: process.env.LEMON_SQUEEZY_SUPPORT_VARIANT_ID,
            name: 'Support Plan',
            features: ['All Features', 'Direct Support Channel', 'Custom Integration Support']
        }
    }
} as const;
