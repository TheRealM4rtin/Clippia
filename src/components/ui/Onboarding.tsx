    ...
    const welcomeNode: Node = {
      ...
      data: {
        ...
        content: [
          ...
          "",
          "- Infinite whiteboard",
          "- Markdown, Image and LaTeX support",
          "- Chat with Clippia",
          ...
          "Click on the floating Clippia3D and use '/' to display Clippia commands in the chat",
          "",
          "Coming soon: ",
          "- Better Landing Page",
          "- Cloud sync and Premium features",
          "",
          "Public launch end of 2024!",
        ].join('\n'),
      },
    };
